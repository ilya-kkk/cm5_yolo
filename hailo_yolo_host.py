...
class HailoYOLOHost:
    ...
    def configure_model(self, network_group_name):
        ...
        try:
            ...
            # Create streams
            self.input_vstream = self.configured_model.create_input_vstream(input_streams[0], input_params)
            self.output_vstream = self.configured_model.create_output_vstream(output_streams[0], output_params)
